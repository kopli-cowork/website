  ...
  return (
    <div className="mb-20 max-w-[330px]">
      ...
      <p className="mb-10 text-base text-dark-text">
        Marati 5/2, Sepikoda building
      </p>
      <div className="flex items-center space-x-5">
        <a
          href="https://www.facebook.com/people/koplicowork/61564326630330/"
        ...
        <a
          href="https://www.linkedin.com/company/koplicowork/"
          aria-label="social-link"
          target="_blank"
          rel="noopener noreferrer"
          className="text-dark-text hover:text-primary dark:hover:text-white"
        ...
        <a
          href="https://www.instagram.com/koplicowork/"
          aria-label="social-link"
          target="_blank"
          rel="noopener noreferrer"
          className="text-dark-text hover:text-primary dark:hover:text-white"
